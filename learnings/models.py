...
class Course(models.Model):
    ...
    preview_image = models.ImageField(upload_to="learnings/course_previews/", verbose_name="Превью", help_text="Подгрузите превью курса", null=True, blank=True)
...
class Lesson(models.Model):
    ...
    preview_image = models.ImageField(upload_to="learnings/lesson_previews/", verbose_name="Превью", help_text="Добавьте превью урока", null=True, blank=True)
    description = models.TextField(verbose_name="Описание", help_text="Добавьте описание урока", null=True, blank=True)
    link_to_video = models.URLField(max_length=500, verbose_name="Ссылка на видео урока", help_text="Добавьте ссылку на видео урока", null=True, blank=True)
